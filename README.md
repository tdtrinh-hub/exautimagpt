...
This repository hosts the **privacy policy** for the exautimagpt Chrome
extension.
...
exautimagpt automates image generation on the ChatGPT website
...
exautimagpt is an independent tool and is not affiliated with, endorsed by, or
